...
const inputClass =
  "w-full h-11 rounded-lg border border-black/10 bg-white px-4 text-sm text-[#1A1A1A] placeholder:text-[#94A3B8] outline-none focus:border-[#DE5943] focus:ring-2 focus:ring-[#DE5943]/20 disabled:opacity-60 disabled:cursor-not-allowed";
          ...
          >
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4 items-start">
              <div className="flex gap-4">
                <div
                  className="w-1 bg-[#DE5943] rounded-full shrink-0"
                  aria-hidden
                />
              ...
              <div className="space-y-5">
                ...
                >
                  ...
                  <label className="space-y-2 sm:col-span-2">
                    ...
                    <textarea
                      {...register("message")}
                      className={`w-full min-h-[128px] resize-none rounded-lg border border-black/10 bg-white px-4 py-3 text-sm text-[#1A1A1A] placeholder:text-[#94A3B8] outline-none focus:border-[#DE5943] focus:ring-2 focus:ring-[#DE5943]/20 disabled:opacity-60 disabled:cursor-not-allowed ${errors.message ? inputErrorClass : ""}`}
                  ...
                  <div className="sm:col-span-2 pt-2">
                    <Button
                      type="submit"
                      className="w-full bg-[#DE5943] hover:bg-[#c94d39] text-white font-semibold rounded-lg"
