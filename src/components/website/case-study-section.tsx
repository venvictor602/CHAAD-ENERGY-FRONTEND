          ...
          >
            ...
            >
              {METRICS.map((m) => (
                <div
                  key={m.label}
                  className="w-full rounded-[8px] bg-[#C44D4D]/10 p-4 space-y-[4px] sm:max-w-[230px]"
                >
            ...
            <motion.div variants={fadeUp} transition={t}>
              <Button
                className="w-full sm:w-auto font-bold text-lg p-8 rounded-[8px] bg-[#C44D4D] hover:bg-[#A33A3A] text-white"
                size="default"
                asChild
              >
