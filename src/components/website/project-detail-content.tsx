        ...
        <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          >
            <section className=" max-w-[620px] w-full space-y-[16px]">
              <h2 className="font-bold text-[24px] border-l-4 border-[#991B1B] pl-[8px] text-[#333333] flex items-center gap-2">
                Project Overview
              </h2>
          ...
          >
            {project.metrics.map((m, i) => {
              ...
              return (
                ...
                >
                  {Icon && (
                    <Icon className="size-[32px] text-[#991B1B] mx-auto" />
                  )}
      ...
      <section className="py-10 sm:py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <motion.div
            ...
            transition={t}
          >
            <h2 className="text-[20px] sm:text-[24px] md:text-[30px] font-extrabold text-[#991B1B]">
            ...
            <Button
              size="default"
              className="bg-[#991B1B] font-bold text-[16px] hover:bg-[#7F1D1D] text-white rounded-[8px]"
              asChild
            >
