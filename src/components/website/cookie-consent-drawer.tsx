          ...
          >
            <div className="w-full bg-white rounded-t-2xl shadow-[0_-4px_24px_rgba(0,0,0,0.12)] border border-[#E8E8E8] border-b-0 overflow-hidden [font-family:var(--font-inter)]">
              <div className="max-w-7xl mx-auto p-5 sm:p-6 flex flex-col sm:flex-row gap-4 sm:gap-6 items-start sm:items-center">
                <div className="shrink-0 w-10 h-10 rounded-full bg-[#A82C3A]/10 flex items-center justify-center">
                  <Cookie className="h-5 w-5 text-[#A82C3A]" aria-hidden />
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-[#64748B] leading-relaxed">
                    ...
                    <Link
                      href="/cookies"
                      className="text-[#A82C3A] font-medium hover:underline underline-offset-2"
                    >
                      Cookie policy
                    </Link>
                  </p>
            ...
            >
              <div className="p-6 sm:p-8">
                ...
                <p className="text-sm text-white/80 leading-relaxed mb-8">
                  ...
                  <Link
                    href="/cookies"
                    className="text-[#A82C3A] hover:underline underline-offset-2"
                  >
                    Cookie policy
                  </Link>
                </p>
                ...
                <div className="mb-6">
                  <div className="flex items-center justify-between gap-3 mb-2">
                    ...
                    <span className="shrink-0 px-2.5 py-0.5 rounded-md bg-[#A82C3A] text-white text-xs font-medium">
                      Always Active
                    </span>
                  </div>
                  ...
                  <div className="flex justify-end">
                    <div
                      className="w-11 h-6 rounded-full bg-[#A82C3A] flex items-center justify-end pr-1 cursor-not-allowed opacity-95"
                      aria-hidden
                    >
                ...
                <div className="flex flex-col-reverse sm:flex-row gap-3 sm:justify-end">
                  ...
                  <Button
                    ...
                    className="bg-[#A82C3A] text-white hover:bg-[#7F222E]"
                  >
                    Save Preferences
                  </Button>
                </div>
