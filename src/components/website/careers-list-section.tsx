    ...
    >
      <div className="p-5 sm:p-6 flex flex-col flex-1">
        <div className="space-y-3">
          <span className="inline-block w-fit px-2 py-1 rounded bg-[#DE5943]/10 text-[#DE5943] text-xs font-semibold tracking-wide">
        ...
        <Link
          ...
          className="mt-4 inline-flex items-center gap-1.5 text-[#DE5943] font-semibold text-sm hover:text-[#c94d39] transition-colors w-fit"
        >
          View & Apply
