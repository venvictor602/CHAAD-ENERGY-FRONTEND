    ...
    >
      <div className="p-5 sm:p-6 flex flex-col flex-1">
        <div className="space-y-3">
          <span className="inline-block w-fit px-2 py-1 rounded bg-[#A82C3A]/10 text-[#A82C3A] text-xs font-semibold tracking-wide">
        ...
        <Link
          ...
          className="mt-4 inline-flex items-center gap-1.5 text-[#A82C3A] font-semibold text-sm hover:text-[#7F222E] transition-colors w-fit"
        >
          View & Apply
