        ...
        <article className="max-w-7xl mx-auto pb-10 px-4 lg:px-0">
          ...
          {post.post_video_link && post.post_video_link.trim() && (
            <div className="mb-8">
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#DE5943] text-white font-medium hover:bg-[#c94d39] transition-colors"
              >
                <ExternalLink className="h-4 w-4" aria-hidden />
                Watch video
              </a>
          ...
          <div className="flex flex-wrap items-center gap-6 mt-10 pt-8 border-t border-[#E8E8E8]">
            ...
            <button
              ...
              onClick={onLike}
              disabled={liking}
              className="inline-flex items-center gap-2 text-[#64748B] hover:text-[#DE5943] disabled:opacity-60 transition-colors"
            >
            ...
            >
              ...
              <div>
                ...
                <input
                  id="comment-name"
                  {...register("name")}
                  className="w-full rounded-lg border border-[#E5E7EB] px-3 py-2 text-[#333333] focus:outline-none focus:ring-2 focus:ring-[#DE5943]"
